...
namespace humpydumpy.Screens
{
    public class AboutScreen : Screen
    {
        ...
        public AboutScreen(Game1 game, TextureHandler textureHandler) { this.textureHandler = textureHandler; this.game = game; }
        ...
        {
            spriteBatch.Draw(textureHandler.AboutScreen, Vector2.Zero, Color.White);
